...
h1 { max-width: 760px; margin-top: 14px; font-family: var(--font-display); font-size: clamp(46px, 4.9vw, 72px); font-weight: 700; letter-spacing: -.055em; line-height: 1.08; }
