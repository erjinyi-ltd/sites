...
h1 { max-width: 720px; margin-top: 14px; font-family: var(--font-display); font-size: clamp(36px, 3.5vw, 40px); font-weight: 700; letter-spacing: 0; line-height: 1.12; }
...
@media (max-width: 640px) {
  ...
  h1 { font-size: clamp(30px, 8.5vw, 34px); }
