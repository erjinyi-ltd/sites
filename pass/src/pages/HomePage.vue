...
<template>
  <main id="top" class="site-shell">
    ...
    <section class="product-showcase content-width" aria-labelledby="product-showcase-title">
      <div class="product-showcase-heading">
        <span>{{ t.ecosystemProductsEyebrow }}</span>
        <h2 id="product-showcase-title">{{ t.ecosystemProductsTitle }}</h2>
        <p>{{ t.ecosystemProductsSubtitle }}</p>
      </div>

      <div class="product-grid">
        <article class="product-card product-card-wallet">
          <div class="product-card-head">
            ...
            <div>
              <span class="product-type">{{ t.walletType }}</span>
              <h3>GCSA Wallet</h3>
            </div>
          </div>
          <p class="product-description">{{ t.walletDescription }}</p>
          <ul class="product-features">
            <li>{{ t.walletFeatureScreening }}</li>
            <li>{{ t.walletFeatureTracing }}</li>
            <li>{{ t.walletFeatureAlerts }}</li>
          </ul>
          <div class="product-actions">
            <a class="product-link product-link-primary" href="https://wallet.gcsa.org/" target="_blank" rel="noopener noreferrer">
              {{ t.officialWebsite }} <span aria-hidden="true">↗</span>
            </a>
          </div>
        </article>

        <article class="product-card product-card-vpn">
          <div class="product-card-head">
            <span class="product-icon" aria-hidden="true">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div>
              <span class="product-type">{{ t.vpnType }}</span>
              <h3>GCSA VPN</h3>
            </div>
          </div>
          <p class="product-description">{{ t.vpnDescription }}</p>
          <ul class="product-features">
            <li>{{ t.vpnFeatureEncryption }}</li>
            <li>{{ t.vpnFeaturePrivacy }}</li>
            <li>{{ t.vpnFeatureDevices }}</li>
          </ul>
          <div class="product-actions">
            <a class="product-link product-link-primary" href="https://gsafevpn.com/" target="_blank" rel="noopener noreferrer">
              {{ t.officialWebsite }} <span aria-hidden="true">↗</span>
            </a>
          </div>
        </article>

        <article class="product-card product-card-homeguard">
          <div class="product-card-head">
            <span class="product-icon" aria-hidden="true">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div>
              <span class="product-type">{{ t.homeGuardType }}</span>
              <h3>GCSA Home Guard</h3>
            </div>
          </div>
          <p class="product-description">{{ t.homeGuardDescription }}</p>
          <ul class="product-features">
            <li>{{ t.homeGuardFeatureCheckup }}</li>
            <li>{{ t.homeGuardFeatureDevices }}</li>
            <li>{{ t.homeGuardFeatureAI }}</li>
          </ul>
          <div class="product-actions">
            <a class="product-link product-link-primary" href="https://homeguard.gcsa.org/" target="_blank" rel="noopener noreferrer">
              {{ t.officialWebsite }} <span aria-hidden="true">↗</span>
            </a>
          </div>
        </article>

        <a class="product-card product-card-more product-more-card-desktop" href="https://gcsa.org/products" target="_blank" rel="noopener noreferrer">
          <span class="product-more-kicker">{{ t.ecosystemProductsEyebrow }}</span>
          <h3>{{ t.moreGcsaProducts }}</h3>
          <p>{{ t.moreGcsaProductsDescription }}</p>
          <span class="product-more-cta">{{ t.viewAllProducts }} <span aria-hidden="true">↗</span></span>
        </a>
        <a class="product-card product-card-more product-more-card-mobile" href="https://gcsa.org/app/products" target="_blank" rel="noopener noreferrer">
          <span class="product-more-kicker">{{ t.ecosystemProductsEyebrow }}</span>
          <h3>{{ t.moreGcsaProducts }}</h3>
          <p>{{ t.moreGcsaProductsDescription }}</p>
          <span class="product-more-cta">{{ t.viewAllProducts }} <span aria-hidden="true">↗</span></span>
