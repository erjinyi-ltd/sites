    ...
    <div class="content-width footer-shell">
      <div class="footer-main">
        <section class="footer-contact" :aria-label="copy.contactUs">
          ...
          <a class="footer-email" href="mailto:tools@gcsa.org">
            <span>{{ copy.email }}</span>
            <strong>tools@gcsa.org</strong>
          </a>
          <div class="socials">
            <a href="https://x.com/gcsa_org" target="_blank" rel="noopener noreferrer">𝕏 <span>{{ copy.twitter }}</span></a>
            <a href="https://t.me/GCSAofficial" target="_blank" rel="noopener noreferrer">↗ <span>{{ copy.telegram }}</span></a>
          </div>
        </section>
      ...
      <div class="footer-bottom">
        ...
        <nav class="footer-legal" :aria-label="copy.menuLabel">
          ...
          <a href="mailto:tools@gcsa.org">tools@gcsa.org</a>
        </nav>
      </div>
    </div>
  </footer>
